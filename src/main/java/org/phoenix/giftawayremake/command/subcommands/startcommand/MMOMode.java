...
public class MMOMode implements CommandInterface {

    private GiftawayCore plugin;

    public MMOMode(GiftawayCore plugin) {
        this.plugin = plugin;
    }
                ...
                if (!(args.length >= 2)) {
                    ...
                    if (plugin.getConfig().getInt("needPlayer") == 0) {
                        ...
                        if (!(Bukkit.getServer().getOnlinePlayers().size() >= plugin.getConfig().getInt("needPlayer"))) {
                            ...
                            if (!(args.length >= 3)) {
                                sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageUSConfig().getString("languages.giftawayReward.MMOMode.noMMOIdItem")));
                            } else {
                                Type type = MMOItems.plugin.getTypes().getOrThrow(args[1]);
                                if (!(args.length >= 4)) {
                                    sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageUSConfig().getString("languages.giftawayReward.MMOMode.noMMOAmount")));
                                } else {
                                    if (args.length != 5) {
                                        sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageUSConfig().getString("languages.giftawayReward.MMOMode.noMMOUnidentify")));
                                    } else {
                                        ItemStack item = new MMOItemDropItem(type, args[2], 1, Double.parseDouble(args[4]) / 100, new RandomAmount(args[3])).getItem(null);
                                        Validate.isTrue(item != null && item.getType() != Material.AIR, ColorCodeTranslate.chat("Couldn't find/generate the item called '" + args[1].toUpperCase() + "'. Check your console for potential item generation issues."));
                                                ...
                                                if (plugin.muted == false) {
                                                    ...
                                                    new BukkitRunnable() {
                                                        ...
                                                        public void run() {
                                                            ...
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(PlaceholderAPI.setPlaceholders(p, LanguageDataFiles.getLanguageUSConfig().getString("languages.giftawayBroadcast.MMOMode.startedGiftaway") + "x" + args[3] + " " + args[2].replace("_", " "))));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                        }
                                                            ...
                                                            if (!Bukkit.getServer().getOnlinePlayers().isEmpty()) {
                                                                ...
                                                                if (Bukkit.getServer().getOnlinePlayers().size() >= plugin.getConfig().getInt("needPlayer")) {
                                                                    if (!plugin.alreadyWin.contains(plugin.rplayer.getUniqueId())) {
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(PlaceholderAPI.setPlaceholders(p, LanguageDataFiles.getLanguageUSConfig().getString("languages.giftawayBroadcast.MMOMode.winnerBroadcast") + "x" + args[2] + " " + args[1].replace("_", " "))));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));

                                                                        new SmartGive(GiftawayCore.getInstance().rplayer).give(item);
                                                                        GiftawayCore.getInstance().rplayer.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + "&aYou receive &b" + "x" + args[3] + " " + args[2].replace("_", " ") + " &a item from giftaway."));
                                                                        new BukkitRunnable() {
                ...
                if (!(args.length >= 2)) {
                    ...
                    if (plugin.getConfig().getInt("needPlayer") == 0) {
                        ...
                        if (!(Bukkit.getServer().getOnlinePlayers().size() >= plugin.getConfig().getInt("needPlayer"))) {
                            ...
                            if (!(args.length >= 3)) {
                                sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageIDConfig().getString("languages.giftawayReward.MMOMode.noMMOIdItem")));
                            } else {
                                Type type = MMOItems.plugin.getTypes().getOrThrow(args[1]);
                                if (!(args.length >= 4)) {
                                    sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageIDConfig().getString("languages.giftawayReward.MMOMode.noMMOAmount")));
                                } else {
                                    if (args.length != 5) {
                                        sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageIDConfig().getString("languages.giftawayReward.MMOMode.noMMOUnidentify")));
                                    } else {
                                        ItemStack item = new MMOItemDropItem(type, args[2], 1, Double.parseDouble(args[4]) / 100, new RandomAmount(args[3])).getItem(null);
                                        Validate.isTrue(item != null && item.getType() != Material.AIR, ColorCodeTranslate.chat("Tidak dapat menemukan/menghasilkan barang yang di sebut '" + args[1].toUpperCase() + "'. Periksa console anda untuk kemungkinan masalah pembuatan barang."));
                                        if (plugin.alreadyCMD == false) {
                                            if (plugin.getConfig().getBoolean("chatMute") == true) {
                                                if (plugin.muted == false) {
                                                    plugin.alreadyCMD = true;
                                                    ...
                                                    new BukkitRunnable() {
                                                        ...
                                                        public void run() {
                                                            ...
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(PlaceholderAPI.setPlaceholders(p, LanguageDataFiles.getLanguageIDConfig().getString("languages.giftawayBroadcast.MMOMode.startedGiftaway") + "x" + args[3] + " " + args[2].replace("_", " "))));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                        }
                                                    }.runTaskLater(plugin, plugin.getConfig().getInt("delay"));
                                                            ...
                                                            if (!Bukkit.getServer().getOnlinePlayers().isEmpty()) {
                                                                ...
                                                                if (Bukkit.getServer().getOnlinePlayers().size() >= plugin.getConfig().getInt("needPlayer")) {
                                                                    if (!plugin.alreadyWin.contains(plugin.rplayer.getUniqueId())) {
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(PlaceholderAPI.setPlaceholders(p, LanguageDataFiles.getLanguageIDConfig().getString("languages.giftawayBroadcast.MMOMode.winnerBroadcast") + "x" + args[2] + " " + args[1].replace("_", " "))));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));

                                                                        new SmartGive(GiftawayCore.getInstance().rplayer).give(item);
                                                                        GiftawayCore.getInstance().rplayer.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + "&aKamu menerima barang &b" + "x" + args[3] + " " + args[2].replace("_", " ") + " &a dari giftaway."));
                                                                        new BukkitRunnable() {
                ...
                if (!(args.length >= 2)) {
                    ...
                    if (plugin.getConfig().getInt("needPlayer") == 0) {
                        ...
                        if (!(Bukkit.getServer().getOnlinePlayers().size() >= plugin.getConfig().getInt("needPlayer"))) {
                            ...
                            if (!(args.length >= 3)) {
                                sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageRUConfig().getString("languages.giftawayReward.MMOMode.noMMOIdItem")));
                            } else {
                                Type type = MMOItems.plugin.getTypes().getOrThrow(args[1]);
                                if (!(args.length >= 4)) {
                                    sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageRUConfig().getString("languages.giftawayReward.MMOMode.noMMOAmount")));
                                } else {
                                    if (args.length != 5) {
                                        sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageRUConfig().getString("languages.giftawayReward.MMOMode.noMMOUnidentify")));
                                    } else {
                                        ItemStack item = new MMOItemDropItem(type, args[2], 1, Double.parseDouble(args[4]) / 100, new RandomAmount(args[3])).getItem(null);
                                        Validate.isTrue(item != null && item.getType() != Material.AIR, ColorCodeTranslate.chat("Не удалось найти/сгенерировать элемент под названием '" + args[1].toUpperCase() + "'. Проверьте консоль на наличие потенциальных проблем с созданием предметов."));
                                        if (plugin.alreadyCMD == false) {
                                            if (plugin.getConfig().getBoolean("chatMute") == true) {
                                                if (plugin.muted == false) {
                                                    plugin.alreadyCMD = true;
                                                    ...
                                                    new BukkitRunnable() {
                                                        ...
                                                        public void run() {
                                                            ...
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(PlaceholderAPI.setPlaceholders(p, LanguageDataFiles.getLanguageRUConfig().getString("languages.giftawayBroadcast.MMOMode.startedGiftaway") + "x" + args[3] + " " + args[2].replace("_", " "))));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                        }
                                                    }.runTaskLater(plugin, plugin.getConfig().getInt("delay"));
                                                            ...
                                                            if (!Bukkit.getServer().getOnlinePlayers().isEmpty()) {
                                                                ...
                                                                if (Bukkit.getServer().getOnlinePlayers().size() >= plugin.getConfig().getInt("needPlayer")) {
                                                                    if (!plugin.alreadyWin.contains(plugin.rplayer.getUniqueId())) {
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(PlaceholderAPI.setPlaceholders(p, LanguageDataFiles.getLanguageRUConfig().getString("languages.giftawayBroadcast.MMOMode.winnerBroadcast") + "x" + args[2] + " " + args[1].replace("_", " "))));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));

                                                                        new SmartGive(GiftawayCore.getInstance().rplayer).give(item);
                                                                        GiftawayCore.getInstance().rplayer.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + "&aВы получите &b" + "x" + args[3] + " " + args[2].replace("_", " ") + " &a товар от Giftaway."));
                                                                        new BukkitRunnable() {
                ...
                if (!(args.length >= 2)) {
                    ...
                    if (plugin.getConfig().getInt("needPlayer") == 0) {
                        ...
                        if (!(Bukkit.getServer().getOnlinePlayers().size() >= plugin.getConfig().getInt("needPlayer"))) {
                            ...
                            if (!(args.length >= 3)) {
                                sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageSAConfig().getString("languages.giftawayReward.MMOMode.noMMOIdItem")));
                            } else {
                                Type type = MMOItems.plugin.getTypes().getOrThrow(args[1]);
                                if (!(args.length >= 4)) {
                                    sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageSAConfig().getString("languages.giftawayReward.MMOMode.noMMOAmount")));
                                } else {
                                    if (args.length != 5) {
                                        sender.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + LanguageDataFiles.getLanguageSAConfig().getString("languages.giftawayReward.MMOMode.noMMOUnidentify")));
                                    } else {
                                        ItemStack item = new MMOItemDropItem(type, args[2], 1, Double.parseDouble(args[4]) / 100, new RandomAmount(args[3])).getItem(null);
                                        Validate.isTrue(item != null && item.getType() != Material.AIR, ColorCodeTranslate.chat("Couldn't find/generate the item called '" + args[1].toUpperCase() + "'. Check your console for potential item generation issues."));
                                        if (plugin.alreadyCMD == false) {
                                                ...
                                                if (plugin.muted == false) {
                                                    ...
                                                    new BukkitRunnable() {
                                                        ...
                                                        public void run() {
                                                            ...
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(PlaceholderAPI.setPlaceholders(p, LanguageDataFiles.getLanguageSAConfig().getString("languages.giftawayBroadcast.MMOMode.startedGiftaway") + "x" + args[3] + " " + args[2].replace("_", " "))));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                            Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                        }
                                                    }.runTaskLater(plugin, plugin.getConfig().getInt("delay"));
                                                            ...
                                                            if (!Bukkit.getServer().getOnlinePlayers().isEmpty()) {
                                                                ...
                                                                if (Bukkit.getServer().getOnlinePlayers().size() >= plugin.getConfig().getInt("needPlayer")) {
                                                                    if (!plugin.alreadyWin.contains(plugin.rplayer.getUniqueId())) {
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(PlaceholderAPI.setPlaceholders(p, LanguageDataFiles.getLanguageSAConfig().getString("languages.giftawayBroadcast.MMOMode.winnerBroadcast") + "x" + args[2] + " " + args[1].replace("_", " "))));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));
                                                                        Bukkit.broadcastMessage(ColorCodeTranslate.chat(""));

                                                                        new SmartGive(GiftawayCore.getInstance().rplayer).give(item);
                                                                        GiftawayCore.getInstance().rplayer.sendMessage(ColorCodeTranslate.chat(plugin.getConfig().getString("prefix") + "&aانت تستقبل &b" + "x" + args[3] + " " + args[2].replace("_", " ") + " &a عنصر من giftaway."));
                                                                        new BukkitRunnable() {
